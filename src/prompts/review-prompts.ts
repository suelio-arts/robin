...
export const PRECISION_INSTRUCTIONS = [
  ...
  "A helper parameter is not a trust boundary. Reject a trigger stated only as 'a caller supplies' an invalid value unless supplied repository evidence identifies a reachable caller, persisted writer, external input boundary, or exported public API that can supply it without the enforcing schema.",
